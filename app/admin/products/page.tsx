  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-[#111827]" style={{ letterSpacing: "-0.02em" }}>Products</h1>
          <p className="text-sm text-[#6B7280] mt-0.5">{products.length} products in catalog</p>
        </div>
        <Link href="/admin/products/new" className={cn(buttonVariants(), "bg-[#6C47FF] hover:bg-[#5B3AE8] text-white inline-flex items-center gap-1.5 border-0 shadow-sm")}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { label: "Total Products", value: products.length, icon: Package, color: "bg-[#F5F2FF] text-[#6C47FF]" },
